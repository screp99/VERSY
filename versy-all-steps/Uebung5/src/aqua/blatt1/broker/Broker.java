	...
	public class BrokerTask implements Runnable {
		...
		public void run() {
			...
			if(payload instanceof RegisterRequest) {
				...
				InetSocketAddress addr = Broker.this.collection.getClient(Broker.this.collection.indexOf(req.getTankId()));
				Broker.this.endpoint.send(this.message.getSender(), new NameResolutionResponse(addr, req.getRequestId()));
			}
		}
