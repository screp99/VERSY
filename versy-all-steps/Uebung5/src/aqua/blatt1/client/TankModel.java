...
public class TankModel extends Observable implements Iterable<FishModel> {
	...
	synchronized void receiveFish(FishModel fish) {
		...
		if(!this.homeAgent.containsKey(fish.getId())) {
	...
	protected synchronized void locateFishGlobally(String fishId) {
		InetSocketAddress addr = this.homeAgent.get(fishId);
	...
	protected synchronized void locateFishLocally(String fishId) {
